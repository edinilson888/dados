...
function Balls:initBall(index, numBall)
  self.balls[index] = newSide_movement(0.1, 0.0, math.random(0 + self.rBall, 800 - self.rBall), 0.0, 600.0, 0.001, self.rBall)
  self.balls[index].image = love.graphics.newImage("imgs/ball" .. numBall .. ".png")
  self.balls[index].sound = love.audio.newSource("sound/Efeito Sonoro.mp3", "static")
end
